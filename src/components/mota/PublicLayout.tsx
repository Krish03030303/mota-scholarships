    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-ink text-ink-foreground">
        <div className="shell flex flex-wrap items-center justify-between gap-2 py-2 text-[11px] sm:text-xs">
          <p className="opacity-90">भारत सरकार · Government of India · Ministry of Tribal Affairs</p>
        ...
        <div className="shell flex items-center justify-between gap-4 py-3">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="leading-tight">
              <span className="block font-display text-base sm:text-lg">Ministry of Tribal Affairs</span>
