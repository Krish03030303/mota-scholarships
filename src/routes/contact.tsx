    ...
    <PublicLayout>
      ...
      <div className="shell grid gap-10 py-10 md:py-14 lg:grid-cols-[1fr_22rem]">
            ...
            {sent ? (
              ...
              >
                <div>
                  ...
                  <Input id="name" required className="mt-2" placeholder="As per your certificate" />
                </div>
                <div>
                  <Label htmlFor="email">Email address</Label>
                  <Input id="email" type="email" required className="mt-2" placeholder="you@example.com" />
                </div>
                <div>
        ...
        <aside className="space-y-4">
          {[
            { icon: Phone, title: "Helpdesk", lines: ["1800 XXX XXXX (toll free)", "011 2338 XXXX"] },
